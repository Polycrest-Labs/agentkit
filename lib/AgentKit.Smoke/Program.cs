...
var config = new ConfigurationBuilder().AddInMemoryCollection(new Dictionary<string, string?>
{
    ...
    ["Llm:Providers:gemini:Kind"] = "openai-compat",
    ["Llm:Providers:gemini:Endpoint"] = "https://generativelanguage.googleapis.com/v1beta/openai/",
    ...
    ["Llm:Models:3:Quirks:GroundingViaExtraBody"] = "true",
